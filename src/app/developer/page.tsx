...
import { Star, Terminal, Code, Cpu, ShieldCheck } from 'lucide-react';
    ...
    <div className="relative min-h-screen bg-[#FFFDF5] text-black flex flex-col justify-between overflow-x-hidden selection:bg-[#C4B5FD] selection:text-black neo-grid-pattern">
      ...
      <div className="flex-1 w-full max-w-6xl mx-auto px-6 md:px-8 lg:px-12 py-10 relative z-10 flex flex-col justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start py-4">
          ...
          {/* LEFT COLUMN: HERO SECTION / BUILDER MANIFESTO */}
          <motion.section 
          ...
          >
            {/* Soft Violet Badge */}
            <div className="inline-block bg-[#C4B5FD] text-black border-4 border-black font-space-900 uppercase text-xs tracking-widest px-4 py-2 shadow-[4px_4px_0px_0px_#000] select-none -rotate-1">
              SKIP THE MEETINGS. WRITE CODE.
            </div>
            ...
            <h1 className="text-black font-space-900 leading-[0.9] tracking-tighter uppercase text-5xl sm:text-7xl md:text-8xl lg:text-[88px] drop-shadow-[5px_5px_0px_rgba(0,0,0,0.15)]">
              Write Code. <br />
              Get Paid. <br />
              <span className="bg-[#C4B5FD] border-4 border-black px-4 py-2 inline-block -rotate-1 shadow-[8px_8px_0px_0px_#000] text-black mt-3">
                Skip Fluff.
              </span>
            </h1>
            ...
            <div className="bg-white border-4 border-black p-6 md:p-8 rounded-none text-black shadow-[8px_8px_0px_0px_#000] relative overflow-hidden">
              ...
              <ul className="space-y-4 font-inter-700 text-base relative z-10 text-black">
                <li className="flex items-start gap-2.5">
                  <span className="text-[#C4B5FD] font-black text-xl leading-none select-none">■</span>
                  <span>
                    <strong className="text-black uppercase">Work on Your Own Terms:</strong> Zero boring client meetings, zero annoying corporate managers, and zero endless revision loops.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-[#C4B5FD] font-black text-xl leading-none select-none">■</span>
                  <span>
                    <strong className="text-black uppercase">Pure Async Coding:</strong> We handle the business, the scoping, and the setup. You just write clean code whenever you want from your couch.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-[#C4B5FD] font-black text-xl leading-none select-none">■</span>
                  <span>
                    <strong className="text-black uppercase">Guaranteed Payouts:</strong> Every project milestone has cash locked securely in escrow before you even start typing.
                  </span>
                </li>
              </ul>
            </div>
          ...
          >
            <div className="space-y-5 p-8 bg-white border-4 border-black rounded-none text-black shadow-[8px_8px_0px_0px_#000] relative overflow-hidden">
              ...
              <div className="flex items-center space-x-2 mb-4 relative z-10">
                <Terminal className="text-black stroke-[3px] w-5 h-5" />
              ...
              <ul className="space-y-8 pt-4 font-inter-700 text-base leading-relaxed text-black relative z-10">
                ...
                <li className="flex items-start gap-4">
                  <span className="text-[#C4B5FD] font-black text-xl leading-none select-none">■</span>
                  <span>
                    <strong className="text-black uppercase">Pre-Scoped Workloads:</strong> Receive explicit technical milestones with fixed product definitions. Absolute protection against feature creep.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-4">
                  <span className="text-[#C4B5FD] font-black text-xl leading-none select-none">■</span>
                  <span>
                    <strong className="text-black uppercase">Asynchronous Freedom:</strong> No stand-up meetings, tracking clocks, or administrative friction. Work whenever you execute best.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-4">
                  <span className="text-[#C4B5FD] font-black text-xl leading-none select-none">■</span>
                  <span>
                    <strong className="text-black uppercase">Milestone Escrow:</strong> Capital is secured upfront inside our network ledger before a single line of code is ever produced.
                  </span>
                </li>
        ...
        {/* ─── LOWER FOLD: INTAKE EXCELLENCE TIMELINE ─── */}
        <motion.section 
        ...
        >
          ...
          <div className="flex items-center space-x-3 mb-10 select-none">
            <Cpu className="text-black stroke-[3.5px] w-7 h-7" />
            <h2 className="font-space-900 text-2xl md:text-3xl uppercase tracking-tight text-black">
              Intake Execution Lifecycle
            </h2>
          </div>

          {/* Lifecycle Timeline Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            
            {/* Step 01 */}
            <div className="space-y-4 p-6 bg-white border-4 border-black rounded-none text-black shadow-[6px_6px_0px_0px_#000] hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_#000] neo-transition relative overflow-hidden">
              <div className="absolute inset-0 pointer-events-none neo-diagonal-pattern opacity-[0.06]" />
              <div className="inline-block px-3 py-1 border-2 border-black bg-[#C4B5FD] font-space-900 text-xs uppercase relative z-10">
                01 / VETTING
              </div>
              <ul className="space-y-2 font-inter-700 text-sm leading-relaxed relative z-10 text-black">
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>Fill out our quick application form.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>Drop your GitHub link or show us your favorite code projects.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>We review it to verify you know how to build real things.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4 p-6 bg-white border-4 border-black rounded-none text-black shadow-[6px_6px_0px_0px_#000] hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_#000] neo-transition relative overflow-hidden">
              ...
              <ul className="space-y-2 font-inter-700 text-sm leading-relaxed relative z-10 text-black">
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>If your work looks solid, we reach out directly via WhatsApp or Email.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>We skip the long interviews and drop you a custom network access key.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>Use that key to instantly unlock our private, closed Discord server.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4 p-6 bg-white border-4 border-black rounded-none text-black shadow-[6px_6px_0px_0px_#000] hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_#000] neo-transition relative overflow-hidden">
              ...
              <ul className="space-y-2 font-inter-700 text-sm leading-relaxed relative z-10 text-black">
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>Claim open coding tasks from our private network board.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>Push your completed code to our staging environment.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C4B5FD] font-black text-sm leading-none select-none">■</span>
                  <span>Get your payout cleared automatically the second your milestone checks out.</span>
                </li>
              </ul>
            </div>
