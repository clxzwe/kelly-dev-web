      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 md:px-8 py-16 relative z-10 flex flex-col justify-center">
        ...
        <div className="bg-white border-4 border-black p-8 md:p-12 rounded-none text-black shadow-[12px_12px_0px_0px_#000] relative overflow-hidden -rotate-1">
          ...
          <div className="flex items-center space-x-3 mb-6">
            <div className="p-2 border-2 border-black bg-[#C4B5FD] rounded-none">
              <Shield size={20} strokeWidth={3} className="text-black" />
            </div>
            <span className="font-mono text-xs uppercase tracking-[0.2em] font-black">
              Arch // Shield Protocol
            </span>
          </div>
          <div className="font-bold leading-relaxed text-base md:text-lg relative z-10 text-neutral-800 space-y-4">
            <div className="font-black text-xl md:text-2xl uppercase tracking-tight text-black mb-2">Our Promise:</div>
            <ul className="space-y-3 list-disc pl-5">
              <li>
                <strong className="text-black font-black">Total Encryption:</strong> Your name, email, Telegram ID, and work portfolio are securely locked inside our private internal directory.
              </li>
              <li>
                <strong className="text-black font-black">Zero Third-Party Sharing:</strong> Kelly will never sell, trade, or share your data with outside brokers, tracking networks, or advertising systems.
              </li>
              <li>
                <strong className="text-black font-black">Closed Loop System:</strong> Everything you submit stays entirely inside our secure, isolated network boundary.
              </li>
            </ul>
          </div>
        </div>
